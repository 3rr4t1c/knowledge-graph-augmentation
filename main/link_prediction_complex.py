from ComplEx.complexModel import ComplEx
from ComplEx.dataset import Dataset
import numpy as np
...
COMPLEX.load_state_dict(torch.load('ComplEx/stored_models/ComplEx_split_degree_build_v2_d500_bs1000.pt')) # Imposta file di modello da caricare
COMPLEX.eval()
print('Done.')
...
if __name__ == '__main__':
    ...
    plist_Lector = read_tsv('ComplEx/data/split_degree_build/train.txt')
