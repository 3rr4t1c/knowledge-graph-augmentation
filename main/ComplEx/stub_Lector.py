...
class StubLector:
    ...
    def train_mode(self, text_corpus):
        ...
        self.phrase2relation = pLt.EXAMPLE_PHRASE2RELATIONS # FOR TESTING
    ...
    def phrase_tracking_mode(self, text_corpus):
        ...
        # FOR TESTING
        phrase2facts = pLt.generate_phrase2facts('data/FB15k-237/test.txt', 
                                                 pLt.EXAMPLE_TARGET_RELATIONS, 
                                                 self.phrase2relation)
        # Quick encoding
